...
atsumori.jacket.attach(io: File.open("#{Rails.root}/db/images/atsumori.jpg"), 
...
ff7.jacket.attach(io: File.open("#{Rails.root}/db/images/FF7REMAKE.jpg"),
...
persona5.jacket.attach(io: File.open("#{Rails.root}/db/images/p5r.jpg"),
                                              filename: 'p5r.jpg',
                                              content_type: 'image/jpeg')
persona5.save
...
biohazard3.jacket.attach(io: File.open("#{Rails.root}/db/images/bio-hazard3.jpg"),
...
assasin_origin.jacket.attach(io: File.open("#{Rails.root}/db/images/assassin-creed-origins.jpg"),
...
witcher_3.jacket.attach(io: File.open("#{Rails.root}/db/images/witcher3.jpg"),
...
fallout4.jacket.attach(io: File.open("#{Rails.root}/db/images/fallout4.jpg"),
...
mario_cart.jacket.attach(io: File.open("#{Rails.root}/db/images/mariokart8.jpg"), 
...
kingdom_hearts.jacket.attach(io: File.open("#{Rails.root}/db/images/kingdom-hearts.jpg"), 
...
sekiro.jacket.attach(io: File.open("#{Rails.root}/db/images/SEKIRO.jpg"), 
                                              filename: 'SEKIRO.jpg', 
                                              content_type: 'image/jpeg')
sekiro.save
